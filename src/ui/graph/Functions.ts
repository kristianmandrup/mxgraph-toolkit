export class Functionas {
  ...
  addForeignObjectWarning(canvas, root) {
    if (root.getElementsByTagName('foreignObject').length > 0)
    {
      ...
      {
        a.setAttribute('xlink:href', static foreignObjectWarningLink);
        a.setAttribute('target', '_blank');
      }
      else
      {
        a.setAttributeNS(mxConstants.NS_XLINK, 'xlink:href', static foreignObjectWarningLink);
      ...
      mxUtils.write(text, static foreignObjectWarningText);
  ...
  insertTableColumn(cell, before)
  {
    ...
    try
    {
      ...
      for (var i = 0; i < model.getChildCount(table); i++)
      {
        ...
        if (geo != null)
        {
          geo.width = static minTableColumnWidth;
      ...
      if (tableGeo != null)
      {
        ...
        tableGeo.width += static minTableColumnWidth;
  ...
  insertTableRow(cell, before)
  {
    ...
    try
    {
      ...
      if (rowGeo != null)
      {
        rowGeo.height = static minTableRowHeight;
